...
set _122_90 PLL_IF_inst|altpll_component|auto_generated|pll1|clk[3]
...
set_max_delay -from network_inst|rgmii_send_inst|tx_pll_inst|altpll_component|auto_generated|pll1|clk[0] -to network_inst|rgmii_send_inst|tx_pll_inst|altpll_component|auto_generated|pll1|clk[0] 22

set_max_delay -from network_inst|rgmii_send_inst|tx_pll_inst|altpll_component|auto_generated|pll1|clk[3] -to network_inst|rgmii_send_inst|tx_pll_inst|altpll_component|auto_generated|pll1|clk[0] 22 

set_max_delay -from LTC2208_122MHz -to LTC2208_122MHz 12
set_max_delay -from LTC2208_122MHz -to PLL_IF_inst|altpll_component|auto_generated|pll1|clk[3] 6
set_max_delay -from _122MHz -to PLL_IF_inst|altpll_component|auto_generated|pll1|clk[3] 6
set_max_delay -from PLL_IF_inst|altpll_component|auto_generated|pll1|clk[3] -to _122MHz 9

set_max_delay -from PHY_RX_CLOCK -to PHY_RX_CLOCK 8

set_max_delay -from _122MHz -to _122MHz 13

set_max_delay -from userADC_clk -to network_inst|rgmii_send_inst|tx_pll_inst|altpll_component|auto_generated|pll1|clk[0] 9

set_max_delay -from network_inst|rgmii_send_inst|tx_pll_inst|altpll_component|auto_generated|pll1|clk[0] -to userADC_clk 1
...
set_min_delay -from network_inst|rgmii_send_inst|tx_pll_inst|altpll_component|auto_generated|pll1|clk[0] -to userADC_clk -2
